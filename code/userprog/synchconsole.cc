...
SynchConsoleInput::SynchConsoleInput(char* inputFile) {
    ...
    static char consoleInString[20] = "console in";
    lock = new Lock(consoleInString);
    waitFor = new Semaphore(consoleInString, 0);
}
...
SynchConsoleOutput::SynchConsoleOutput(char* outputFile) {
    ...
    static char consoleOutString[20] = "console out";
    lock = new Lock(consoleOutString);
    waitFor = new Semaphore(consoleOutString, 0);
}
