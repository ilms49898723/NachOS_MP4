...
Kernel::Initialize() {
    ...
    static char mainString[10] = "main";
    currentThread = new Thread(mainString, threadNum++);
...
Kernel::ThreadSelfTest() {
    ...
    static char testString[50] = "test";
    semaphore = new Semaphore(testString, 0);
    semaphore->SelfTest();
    delete semaphore;
