...
SynchList<T>::SynchList() {
    list = new List<T>;
    static char listLockString[50] = "list lock";
    static char listEmptyCondString[50] = "list empty cond";
    lock = new Lock(listLockString);
    listEmpty = new Condition(listEmptyCondString);
}
...
SynchList<T>::SelfTest(T val) {
    static char pingString[10] = "ping";
